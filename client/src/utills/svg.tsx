...
export const SearchSVG: React.FC<searchSVGprops> = (props) => {
  return (
    <div
      onClick={() => {
        if (props.onClick) {
      ...
      className={`facebook-icon  ${props.className}`}
    >
